...
// Crypper
#define COCOAPODS_POD_AVAILABLE_Crypper
#define COCOAPODS_VERSION_MAJOR_Crypper 0
#define COCOAPODS_VERSION_MINOR_Crypper 1
#define COCOAPODS_VERSION_PATCH_Crypper 0
